...
{	
	 ...
	 */
	public List<AirportInterface> getShortestFlight(String startingAirportName, String endingAirportName);
	 ...
	 * @return List of cities to travel for(This is a list in order to account for possible connecting flights)
	 */
	public List<AirportInterface> getMultiStopVacation(List<String> allAirportNames);
	 ...
	 */
	public boolean getAvailability(String startingAirportName, String endingAirportName);
